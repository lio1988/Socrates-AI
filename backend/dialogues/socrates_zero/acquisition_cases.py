...
_BASE_SEMANTIC_ID = "acqrequest_" + "1" * 64
_BASE_CONFIG = "2" * 64
_WRONG_CONFIG = "3" * 64
...
FROZEN_ACQUISITION_ORTHOGONAL_PROBES_V0: Tuple[AcquisitionProbeV0, ...] = (
    ...
    _probe("acqv0-o02-semantic-id-tamper", O, "P02_SEMANTIC_IDENTITY_INTEGRITY", "INVALID_SEMANTIC_IDENTITY", "Tamper only the stored semantic request ID.", (_mutation("request.semantic_request_id", _BASE_SEMANTIC_ID, "acqrequest_" + "0" * 64),), _vector(semantic_request_identity=I)),
    _probe("acqv0-o03-required-provider-verification-unknown", O, "P04_REQUIRED_CONTROL_COMPLETENESS", "REQUIRED_CONTROL_UNKNOWN", "Set only required actual-provider verification capability to UNKNOWN.", (_mutation("capability.actual_provider_identity_verification", "PROVEN_SUPPORTED", "UNKNOWN"),), _vector(capability_controls=I)),
    _probe("acqv0-o04-non-canned-transport", O, "P05_CANNED_ONLY_TRANSPORT_MODE", "CANNED_ONLY_POLICY_VIOLATION", "Change only transport mode from CANNED_ONLY to EXTERNAL.", (_mutation("capability.transport_mode", "CANNED_ONLY", "EXTERNAL"),), _vector(capability_controls=D, transport_mode=I)),
    _probe("acqv0-o05-external-network-enabled", O, "P06_EXTERNAL_NETWORK_PROHIBITION", "EXTERNAL_NETWORK_FORBIDDEN", "Keep canned mode but change only external-network control to enabled.", (_mutation("capability.external_network", "PROVEN_DISABLED", "PROVEN_SUPPORTED"),), _vector(capability_controls=D, external_network=I)),
    _probe("acqv0-o06-credential-access-enabled", O, "P07_CREDENTIAL_ACCESS_PROHIBITION", "CREDENTIAL_ACCESS_FORBIDDEN", "Change only credential-access control to enabled without reading a credential.", (_mutation("capability.credential_access", "PROVEN_DISABLED", "PROVEN_SUPPORTED"),), _vector(capability_controls=D, credential_access=I)),
    _probe("acqv0-o07-exact-model-verification-unsupported", O, "P08_EXACT_IDENTITY_VERIFICATION", "EXACT_IDENTITY_VERIFICATION_UNAVAILABLE", "Change only actual exact-model verification to explicitly unsupported.", (_mutation("capability.actual_model_identity_verification", "PROVEN_SUPPORTED", "PROVEN_UNSUPPORTED"),), _vector(capability_controls=I)),
    _probe("acqv0-o08-fallback-disablement-unknown", O, "P04_REQUIRED_CONTROL_COMPLETENESS", "REQUIRED_CONTROL_UNKNOWN", "Change only fallback control from proven disabled to UNKNOWN.", (_mutation("capability.fallback", "PROVEN_DISABLED", "UNKNOWN"),), _vector(capability_controls=D, fallback=I)),
    _probe("acqv0-o09-retry-disablement-unknown", O, "P04_REQUIRED_CONTROL_COMPLETENESS", "REQUIRED_CONTROL_UNKNOWN", "Change only runner retry control from proven disabled to UNKNOWN.", (_mutation("capability.retry", "PROVEN_DISABLED", "UNKNOWN"),), _vector(capability_controls=D, retry=I)),
    _probe("acqv0-o10-sdk-retry-disablement-unknown", O, "P04_REQUIRED_CONTROL_COMPLETENESS", "REQUIRED_CONTROL_UNKNOWN", "Change only SDK-internal retry control from proven disabled to UNKNOWN.", (_mutation("capability.sdk_internal_retry", "PROVEN_DISABLED", "UNKNOWN"),), _vector(capability_controls=D, sdk_internal_retry=I)),
    _probe("acqv0-o11-tools-enabled", O, "P12_TOOLS_DISABLED", "TOOLS_NOT_DISABLED", "Change only the tool-exposure capability to enabled.", (_mutation("capability.tools", "PROVEN_DISABLED", "PROVEN_SUPPORTED"),), _vector(capability_controls=D, tools=I)),
    _probe("acqv0-o12-timeout-termination-unknown", O, "P04_REQUIRED_CONTROL_COMPLETENESS", "REQUIRED_CONTROL_UNKNOWN", "Change only worker-termination guarantee to UNKNOWN.", (_mutation("capability.worker_termination", "PROVEN_SUPPORTED", "UNKNOWN"),), _vector(capability_controls=D, worker_termination=I)),
    _probe("acqv0-o13-resource-accounting-incomplete", O, "P14_RESOURCE_ACCOUNTING", "RESOURCE_ACCOUNTING_INCOMPLETE", "Change only cost-reporting capability to explicitly unsupported.", (_mutation("capability.cost_reporting", "PROVEN_SUPPORTED", "PROVEN_UNSUPPORTED"),), _vector(capability_controls=D, usage_completeness=I)),
    _probe("acqv0-o14-budget-insufficient", O, "P15_BUDGET_SUFFICIENCY", "BUDGET_INCOMPLETE", "Change only the per-attempt canned-invocation ceiling from one to zero.", (_mutation("budget.max_canned_transport_invocations", 1, 0),), _vector(budget=I)),
    ...
    _probe("acqv0-o16-canned-transport-unregistered", O, "P18_CANNED_TRANSPORT_REGISTRATION", "CANNED_TRANSPORT_UNREGISTERED", "Remove only the exact canned transport registration.", (_mutation("transport_registry.baseline_canned.registered", True, False),), _vector(transport_registration=I)),
    ...
    _probe("acqv0-o18-transport-timeout-worker-terminated", O, "A02_TRANSPORT_COMPLETION", "TRANSPORT_TIMEOUT", "Return a deterministic timeout terminal envelope with acknowledged worker termination.", (_mutation("envelope.transport_status", "COMPLETED", "TIMEOUT"),), _vector(timeout=I, response_presence=D, response_digest=N)),
    ...
    _probe("acqv0-o26-missing-raw", O, "A10_RAW_RESPONSE_PRESENCE", "MISSING_RAW_OBSERVATION", "Remove only raw response bytes from an otherwise complete envelope.", (_mutation("envelope.raw_response_bytes", "FROZEN_COMPLETE_RAW_RESPONSE_BYTES_V0", None),), _vector(response_presence=I, response_digest=N)),
    ...
    _probe("acqv0-o31-source-isolation-mismatch", O, "A14_ISOLATION_INTEGRITY", "ISOLATION_FAILURE", "Change only the test-owned source after-fingerprint evidence.", (_mutation("isolation_receipt.source_after", "source-before", "source-mutated-sentinel"),), _vector(branch_isolation=I)),
    _probe("acqv0-o32-sibling-isolation-mismatch", O, "A14_ISOLATION_INTEGRITY", "ISOLATION_FAILURE", "Change only the test-owned sibling after-fingerprint evidence.", (_mutation("isolation_receipt.sibling_after", "sibling-before", "sibling-mutated-sentinel"),), _vector(branch_isolation=I)),
    _probe("acqv0-o33-production-isolation-mismatch", O, "A14_ISOLATION_INTEGRITY", "ISOLATION_FAILURE", "Change only the detached production-control after-fingerprint evidence.", (_mutation("isolation_receipt.production_after", "production-before", "production-mutated-sentinel"),), _vector(branch_isolation=I)),
    _probe("acqv0-o34-retention-policy-violation", O, "A15_RETENTION_PRIVACY_INTEGRITY", "RETENTION_POLICY_VIOLATION", "Change only artifact inclusion for a fixture classified PRIVATE from DIGEST_ONLY to RAW.", (_mutation("retention_receipt.artifact_inclusion", "DIGEST_ONLY", "RAW_PRIVATE"),), _vector(retention=I)),
    _probe("acqv0-o35-final-receipt-identity-mismatch", O, "A16_FINAL_RECEIPT_INTEGRITY", "RECEIPT_MISMATCH", "Tamper only the final receipt content identity.", (_mutation("attempt_receipt.receipt_id", "acqreceipt_" + "4" * 64, "acqreceipt_" + "0" * 64),), _vector(receipt_identity=I)),
...
FROZEN_ACQUISITION_PRECEDENCE_PROBES_V0: Tuple[AcquisitionProbeV0, ...] = (
    ...
    _probe("acqv0-p05-missing-raw-plus-usage-incomplete", X, "A10_RAW_RESPONSE_PRESENCE", "MISSING_RAW_OBSERVATION", "Remove raw bytes and make usage incomplete; raw presence wins.", (_mutation("envelope.raw_response_bytes", "FROZEN_COMPLETE_RAW_RESPONSE_BYTES_V0", None), _mutation("envelope.new_usage_completeness", "COMPLETE", "INCOMPLETE")), _vector(response_presence=I, response_digest=N, usage_completeness=I)),
    _probe("acqv0-p06-network-plus-credential-policy", X, "P06_EXTERNAL_NETWORK_PROHIBITION", "EXTERNAL_NETWORK_FORBIDDEN", "Enable external-network and credential-access intent without executing either; network guard wins.", (_mutation("capability.external_network", "PROVEN_DISABLED", "PROVEN_SUPPORTED"), _mutation("capability.credential_access", "PROVEN_DISABLED", "PROVEN_SUPPORTED")), _vector(capability_controls=D, external_network=I, credential_access=I)),
    _probe("acqv0-p07-timeout-plus-worker-nontermination", X, "A02_TRANSPORT_COMPLETION", "TRANSPORT_TIMEOUT", "Return timeout status and worker nontermination; transport completion wins.", (_mutation("envelope.transport_status", "COMPLETED", "TIMEOUT"), _mutation("envelope.worker_terminated", True, False)), _vector(timeout=I, worker_termination=I, response_presence=D, response_digest=N)),
)
